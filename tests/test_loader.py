    ...
    check_script(
        {
            "test_pck/__init__.py":\
                                    """\ from .mx import x from .my import y.
...
def test_loader_keywords():
    check_script(
        {
            "test_pck/__init__.py":\
                                    """\ from .mx import x print("imported
                                    init")
...
""",
        ...
        """\ from test_pck import use_x print("x:",use_x())"""
   ,
        transformed_stdout=snapshot(\
                                    """\ imported init imported mx x: 5."""
   ),
        transformed_stderr=snapshot("<equal to normal>"),
        normal_stdout=snapshot(\
                               """\ imported mx imported init x: 5."""
   ),
        normal_stderr=snapshot(""),
    )
...
def test_lazy_module_attr():
    check_script(
        {
            "test_pck/__init__.py":\
                                    """\ from .mx import x from .my import
                                    y."""
   ,
            "test_pck/mx.py":\
                              """\
...
""",
        transformed_stdout=snapshot(\
                                    """\ <module 'test_pck' from
                                    '<exec_prefix>/test_pck/__init__.py'>
                                    dict_keys(['__name__', '__doc__',
        ...
        normal_stdout=snapshot(\
                               ...
                               '__file__', '__cached__', '__builtins__', 'mx',
                               'x', 'my', 'y'])"""
   ),
        normal_stderr=snapshot(""),
    )
...
""",
   ...
   ,
        transformed_stdout=snapshot(\
                                    """\ inside dict_keys(['__name__',
                                    '__doc__', '__package__', '__loader__',
                                    '__spec__', '__path__', '__file__',
                                    '__cached__', '__builtins__', 'x']) mx
                                    <module 'test_pck.mx' from
                                    '<exec_prefix>/test_pck/mx.py'> inside
                                    dict_keys(['__name__', '__doc__',
                                    '__package__', '__loader__', '__spec__',
                                    '__path__', '__file__', '__cached__',
                                    '__builtins__', 'x', 'mx']) outside
                                    dict_keys(['__name__', '__doc__',
                                    '__package__', '__loader__', '__spec__',
                                    '__path__', '__file__', '__cached__',
                                    '__builtins__', 'x', 'mx', 'later']) later
                                    dict_keys(['__name__', '__doc__',
                                    '__package__', '__loader__', '__spec__',
                                    '__path__', '__file__', '__cached__',
                                    '__builtins__', 'x', 'mx', 'later'])"""
   ),
        transformed_stderr=snapshot("<equal to normal>"),
        normal_stdout=snapshot(\
                               """\ inside dict_keys(['__name__', '__doc__',
                               '__package__', '__loader__', '__spec__',
                               '__path__', '__file__', '__cached__',
                               '__builtins__', 'mx', 'x']) mx <module
                               'test_pck.mx' from
                               '<exec_prefix>/test_pck/mx.py'> inside
                               dict_keys(['__name__', '__doc__', '__package__',
                               '__loader__', '__spec__', '__path__',
                               '__file__', '__cached__', '__builtins__', 'mx',
                               'x']) outside dict_keys(['__name__', '__doc__',
                               '__package__', '__loader__', '__spec__',
                               '__path__', '__file__', '__cached__',
                               '__builtins__', 'mx', 'x', 'later']) later
                               dict_keys(['__name__', '__doc__', '__package__',
                               '__loader__', '__spec__', '__path__',
                               '__file__', '__cached__', '__builtins__', 'mx',
                               'x', 'later'])"""
...
"""
   ,
        transformed_stdout=snapshot(\
                                    """\ LazyImportError: Deferred importing of
                                    module 'test_pck.m' caused an error⏎
                                    ValueError: ⏎"""
   ),
        transformed_stderr=snapshot("<equal to normal>"),
        normal_stdout=snapshot(\
...
"""
   ,
        transformed_stdout=snapshot(\
                                    """\ LazyImportError: Deferred importing of
                                    module '.y' in 'test_pck.m' caused an
                                    error⏎ ValueError: ⏎"""
   ),
        transformed_stderr=snapshot("<equal to normal>"),
        normal_stdout=snapshot(\
...
""",
            "test_pck/mb.py":\
                              """\ from test_pck import ma a=ma.a."""
   ,
        },
        """\
...
""",
        ...
        """\ from test_pck import foo import test_pck.

        foo() test_pck.b=lambda:6 foo()
        """
   ,
        transformed_stdout=snapshot("<equal to normal>"),
        transformed_stderr=snapshot("<equal to normal>"),
...
""",
        transformed_stdout=snapshot(\
                                    """\ <class
                                    'lazy_imports_lite._loader.LazyLoader'>"""
   ),
        transformed_stderr=snapshot("<equal to normal>"),
        normal_stdout=snapshot(\
                               """\ <class '_frozen_importlib_external.SourceFi
                               leLoader'>"""
   ),
        normal_stderr=snapshot(""),
    )
...
""",
        ...
        """\ import test_pck import test_pck.a import test_pck.b.

        for pck in (test_pck,test_pck.a,test_pck.b):
        print(pck.__name__,
        str(type(pck.__spec__.loader)).replace("_",""))
        """
   ,
        transformed_stdout=snapshot(\
                                    """\ test_pck <class
                                    'frozenimportlibexternal.NamespaceLoader'>
                                    test_pck.a <class
                                    'lazyimportslite.loader.LazyLoader'>
                                    test_pck.b <class 'frozenimportlibexternal.
                                    SourceFileLoader'>"""
   ),
        transformed_stderr=snapshot("<equal to normal>"),
        normal_stdout=snapshot(\
                               ...
                               'frozenimportlibexternal.NamespaceLoader'>
                               test_pck.a <class
                               'frozenimportlibexternal.SourceFileLoader'>
                               test_pck.b <class
                               'frozenimportlibexternal.SourceFileLoader'>"""
   ),
        normal_stderr=snapshot(""),
